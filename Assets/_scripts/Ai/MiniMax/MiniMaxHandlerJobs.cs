...
//public class MiniMaxHandlerJobs : MonoBehaviour, IMiniMax
//{
//    AiPiecePostUpdater aiPiecePostUpdater;

//    HeuristicFunctionCalc heuristicFunctionCalc;
//    delegate List<Vector2Int> _getMovableTiles();
...
//        NativeHashMap<int, int> _pieceIPieceDict = new();
//        Dictionary<IPiece, int> _iPieceToIntConvDict = new();
//        Dictionary<GameObject, int> _pieceToIntConvDict = new();


//        int _val = 0;
//        foreach (GameObject x in _blackPiece.Values)
//        {
//            _iPieceToIntConvDict.Add(x.GetComponent<IPiece>(), _val);
//            _pieceToIntConvDict.Add(x, _val);
//            _val++;
//            _pieceIPieceDict.Add(_val, x.GetComponent<IPiece>());
//        }
...
//        //recursively calls itself and find the scores 
